    ...
    if ($active_tab == 'cache_management') {
        ...
        <div style="margin-top: 20px;">
            ...
            <table class="form-table">
                ...
                <tr>
                    <th scope="row">🎯 Cache de Atrações</th>
                    <td>
                        <button type="button" id="viator-clear-attractions-cache" class="button button-secondary">🗑️ Limpar Cache de Carrosséis (7 dias)</button>
                        <p class="description">
                            <strong>Cache Automático:</strong> Os carrosséis de atrações são armazenados em cache por 7 dias para melhor performance.<br>
                            Use este botão se precisar atualizar os dados imediatamente ou resolver problemas de carregamento.
                        </p>
                        <div id="attractions-cache-result" style="margin-top: 10px;"></div>
                    </td>
                </tr>
            ...
            jQuery(document).ready(function($) {
                ...
                // Cache de Atrações
                $('#viator-clear-attractions-cache').on('click', function() {
                    var button = $(this);
                    var resultDiv = $('#attractions-cache-result');
                    
                    button.prop('disabled', true).text('🔄 Limpando...');
                    resultDiv.html('<span style="color: #0073aa;">Limpando cache de carrosséis...</span>');
                    
                    $.ajax({
                        url: ajaxurl,
                        type: 'POST',
                        data: {
                            action: 'viator_clear_cache',
